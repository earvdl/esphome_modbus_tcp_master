...
- 📊 **Multiple Data Types** - Reads 16-bit and 32-bit signed/unsigned integers with scaling. Supports both big endian (most significant 16-bit word first) and little endian (least significant word first) for 32-bit integers.
